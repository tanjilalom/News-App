...
class DhakaTribuneScreen extends StatefulWidget {
  const DhakaTribuneScreen({super.key});

  @override
  State<DhakaTribuneScreen> createState() => _DhakaTribuneScreenState();
}

class _DhakaTribuneScreenState extends State<DhakaTribuneScreen> {
  static const _baseUrl = 'https://www.dhakatribune.com';
  static const _accentColor = Color(0xFF1B5E20);
  static const _pageUrl = 'https://www.dhakatribune.com/latest';
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: PortalAppBar(
          title: Text('Dhaka Tribune',
              style: GoogleFonts.poppins(
                  fontWeight: FontWeight.w700, fontSize: 20, color: Colors.white)),
          subtitle: const Text('dhakatribune.com'),
    ...
    return RefreshIndicator(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (ctx, i) {
          ...
          return NewsListTile(
              item: item, accentColor: _accentColor, bengaliFont: false,
