...
class DhakaPostScreen extends StatefulWidget {
  const DhakaPostScreen({super.key});

  @override
  State<DhakaPostScreen> createState() => _DhakaPostScreenState();
}

class _DhakaPostScreenState extends State<DhakaPostScreen> {
  static const _baseUrl = 'https://dhakapost.com';
