...
class SomoyNewsScreen extends StatefulWidget {
  const SomoyNewsScreen({super.key});

  @override
  State<SomoyNewsScreen> createState() => _SomoyNewsScreenState();
}

class _SomoyNewsScreenState extends State<SomoyNewsScreen> {
  static const _baseUrl = 'https://www.somoynews.tv';
  static const _accentColor = Color(0xFFC62828);
  static const _pageUrl = 'https://www.somoynews.tv/latest-news';
