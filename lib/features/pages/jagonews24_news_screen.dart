...
class JagoNews24Screen extends StatefulWidget {
  const JagoNews24Screen({super.key});

  @override
  State<JagoNews24Screen> createState() => _JagoNews24ScreenState();
}

class _JagoNews24ScreenState extends State<JagoNews24Screen> {
  static const _baseUrl = 'https://www.jagonews24.com';
  static const _accentColor = Color(0xFFE65100);
  static const _pageUrl = 'https://www.jagonews24.com/all-news';
