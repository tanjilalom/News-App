...
class NewAgeScreen extends StatefulWidget {
  const NewAgeScreen({super.key});

  @override
  State<NewAgeScreen> createState() => _NewAgeScreenState();
}

class _NewAgeScreenState extends State<NewAgeScreen> {
  static const _baseUrl = 'https://newagebd.net';
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: PortalAppBar(
          ...
          subtitle: const Text('newagebd.net'),
          gradientColors: const [Color(0xFFAD1457), Color(0xFF880E4F)],
          actions: [
            IconButton(
